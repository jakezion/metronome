...
(function (modules, entry, mainEntry, parcelRequireName, globalName) {
  ...
  "1xC6H": [function (require, module, exports) {
    ...
    "react-refresh/runtime": "786KC",
    "react-error-overlay": "1dldy"
  }],
  "786KC": [function (require, module, exports) {
    "use strict";

    module.exports = require("./cjs/react-refresh-runtime.development.js");
  }, {
    "./cjs/react-refresh-runtime.development.js": "hdge7"
  }],
  "hdge7": [function (require, module, exports) {
    ...
    (function () {
      ...
      function performReactRefresh() {
        ...
        try {
          ...
          updates.forEach(function (_ref) {
            ...
            if (canPreserveStateBetween(prevType, nextType)) updatedFamilies.add(family);else staleFamilies.add(family);
      ...
      function register(type, id) {
        if (type === null) return;
        if (typeof type !== "function" && _typeof(type) !== "object") return; // This can happen in an edge case, e.g. if we register
        ...
        if (_typeof(type) === "object" && type !== null) switch (type.$$typeof) {
          ...
          if (alternate !== null) {
            ...
            if (!wasMounted && isMounted) {
              ...
              if (didError) // We'll remount it on future edits.
                failedRoots.add(root);else helpersByRoot["delete"](root);
          ...
          return (Q = j(A.a.mark(function e(t, r) {
            ...
            return A.a.wrap(function (e) {
              for (;;) {
                switch (e.prev = e.next) {
                  case 0:
                    if (n = l.length > 2 && void 0 !== l[2] ? l[2] : 3, o = "object" == _typeof(t) ? t.contents : null, a = "object" == _typeof(t) ? t.uri : t, null != o) {
                      e.next = 7;
                      break;
                    }
  ...
  "hlQkH": [function (_require, module, exports) {
    "use strict";
    ...
    module.bundle.HMR_BUNDLE_ID = "9f8e6299c9e4c151";
    ...
    */
    ...
    if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== "undefined") {
      ...
      ws.onmessage = /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
          var data, assets, handled, i, id, _iterator, _step, ansiDiagnostic, stack, overlay;
    ...
    function fullReload() {
      if ("reload" in location) location.reload();else if (extCtx && extCtx.runtime && extCtx.runtime.reload) extCtx.runtime.reload();
    }
    ...
    function hmrDownload(asset) {
      if (asset.type === "js") {
        if (typeof document !== "undefined") {
          ...
          // Worker scripts
          if (asset.outputFormat === "esmodule") return Promise.resolve("".concat(asset.url + "?t=" + Date.now())).then(function (s) {
    ...
    function hmrApply(bundle, asset) {
      var modules = bundle.modules;
      if (!modules) return;
      if (asset.type === "css") reloadCSS();else if (asset.type === "js") {
  ...
  "7Hf4O": [function (require, module, exports) {
    var dataPoints = [];
    /*
    Ran on button input from react.
    Will calculate the average times of 8 button presses
    and return the resulting BPM.
    
    */

    var onButtonPress = function onButtonPress(e) {
      console.log(e.timeStamp());
    };

    var setCurrentBPM = function setCurrentBPM() {};

    var updateCurrentBPM = function updateCurrentBPM() {};
  }, {}]
}, ["1xC6H", "hlQkH", "7Hf4O"], "7Hf4O", "parcelRequire4dfd");
//# sourceMappingURL=index.c9e4c151.js.map